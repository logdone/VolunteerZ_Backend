package com.wsfb.volunteer.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.wsfb.volunteer.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.wsfb.volunteer.repository.UserRepository.USERS_BY_EMAIL_CACHE);
